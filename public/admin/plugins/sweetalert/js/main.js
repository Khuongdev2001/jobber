! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() {
    ...
    var Tt = { promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap },
        ...
        It = {};
    It.text = It.email = It.password = It.number = It.tel = It.url = function(t, e) { return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : w(e.inputValue) || W('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')), St(t, t, e), Ot(t, e), t.type = e.input, t }, It.file = function(t, e) { return St(t, t, e), Ot(t, e), t }, It.range = function(t, e) {
    ...
    function ae(t) { for (var e in t) ie(o = e) || W('Unknown parameter "'.concat(o, '"')), t.toast && (n = e, -1 !== le.indexOf(n) && W('The parameter "'.concat(n, '" is incompatible with toasts'))), re(n = e) && v(n, re(n)); var n, o }
